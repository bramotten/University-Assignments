...
def resnet_model_fn(features, labels, mode, params):
  ...
  if mode == tf.estimator.ModeKeys.TRAIN:
    ...
    learning_rate = gradual_warmup_then_dec(0.1, int(batches_per_epoch * 5) , 3.2, global_step, FLAGS.train_steps, name="gradual_warmup_then_dec")
    learning_rate_previous = gradual_warmup_then_dec(0.1, int(batches_per_epoch * 5) , 3.2, global_step-1, FLAGS.train_steps, name="gradual_warmup_then_dec")
    ...
    def host_call_fake(gs, loss, lr, ce):
