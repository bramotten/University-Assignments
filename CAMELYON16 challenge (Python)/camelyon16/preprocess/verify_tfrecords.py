# Source: https://gist.github.com/LeegleechN/65620cd3978d8588c5707ea7006f5e64
...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string("input_data_pattern", "/scratch/shared/camelyon16/512/Processed/patch-based-classification/tf-records/*",
